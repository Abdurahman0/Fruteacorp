...
const [likedProducts, setLikedProducts] = useState([]); 
  ...
  const fetchPopularProducts = useCallback(async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error(`Error ${response.status}: Failed to fetch popular products.`);
      }
  ...
  return (
    <>
      ...
      <div className="container mx-auto p-4">
        <h2 className="text-3xl border-b-[1px] pb-4 mt-12 mb-5 font-normal w-[100%]">Istaklarim</h2>
        {wishes.length === 0 ? (
              ...
              return (
                ...
                >
                  <div className="relative bg-[#EFEFEF]">
                    ...
                    >
                      <GiSelfLove style={{ color: wish.liked ? "red" : "gray" }} />
                    </button>
                  </div>
                  <div className="p-3">
