  ...
  return (
    <>
        <div className='border my-[100px] z-100 w-[500px]  p-[10px] m-auto rounded-lg'>
            ...
            <p className='mb-[10px]'>Mutaxassislarimizga siz uchun qulay shaklda savol bering:</p>
            <div>
                <a href="https://t.me/fruteacorp" className='flex hover:bg-green-300 duration-500 rounded-lg'>
            ...
            <div>
                <a href="tel:+998998835888" className='flex hover:bg-green-300 duration-500 rounded-lg'>
